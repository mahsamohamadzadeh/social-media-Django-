...
class ShowPosts(View):
    ...
    def get(self, request):
        ...
        if request.GET.get('search'):
            posts = posts.filter(body__startswith=request.GET['search'])
        return render(request, 'post/index.html', {'posts': posts, 'form': self.form_class})
...
class PostDetailView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return redirect('post:post-detail', self.post_instance.id, self.post_instance.slug)
...
class PostUpdateView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return redirect('post:post-detail', post.id, post.slug)
